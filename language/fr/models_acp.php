...
$lang = array_merge($lang, array(
	...
	'MODEL_AUTH_EXPLAIN'	=> 'Détermine la permission requise pour voir ce modèle. <br />Vous devrez également autoriser les membres à utiliser les modèles de message en réglant la permission adéquate.',
	'MODEL_ALREADY_EXIST'	=> 'Un modèle existe déjà avec ce titre, saisissez un autre titre pour ce modèle.',
	'MODEL_CONTENT'			=> 'Contenu du modèle',
	'MODEL_CONTENT_EXPLAIN'	=> 'Le contenu du modèle sera inséré tel quel dans le corps du message',
	'MODEL_EDIT'			=> 'Modifier le modèle de message',
	'MODEL_EDIT_EXPLAIN'	=> 'Vous pouvez ajouter ou modifier un modèle de message.',
	'MODEL_LANGUAGE'		=> 'Langue',
	'MODEL_PM'				=> 'Afficher dans la messagerie privée',
	'MODEL_PM_EXPLAIN'		=> 'Vous devrez également autoriser les membres à utiliser les modèles de message dans la messagerie privée en réglant la permission adéquate.',
